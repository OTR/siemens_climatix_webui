...
class MySession(requests.Session):
    def __init__(self, *args, **kwargs):
        ...
        self.basedir = "C:/Users/User/AppData/logs/" # FIXME: ged rid of hardcoded path
    ...
    def get_crash_hist(self):
        ...
        while not isLast:
            ...
            if entry["text"] == "":
                ...
                pattern = f'{entry["time_found"]}\t{entry["text"].ljust(60)}\t{entry["priority"]}\t{entry["prior_text"].ljust(15)}\t{entry["date"]}'
    ...
    def simple_txt(self):
        ...
        pattern = f'{params["time"]}\t{params["temp_intake"]}\t{int(params["vol_intake"])}\t\t{params["temp_exhaust"]}\t{int(params["vol_exhaust"])}\n'
