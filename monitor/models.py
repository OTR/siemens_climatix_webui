...
class TempVolModel(models.Model):
    ...
    class CvuName(models.TextChoices):
    ...
    CVU_name = models.CharField(max_length=1, choices=CvuName.choices,
                                default=CvuName.CVU_1_1)
    ...
    def get_name(self):
        ...
        return f"{self.CvuName(self.CVU_name).label}"
